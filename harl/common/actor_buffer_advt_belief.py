...
class ActorBufferAdvtBelief:
    ...
    def __init__(self, args, obs_space, act_space, num_agents):
        ...
        self.belief = np.zeros((self.episode_length + 1, self.n_rollout_threads, self.num_agents), dtype=np.float32)
    ...
    def insert(self, obs, belief, ground_truth_type, rnn_states, adv_rnn_states, belief_rnn_states, actions, adv_actions, action_log_probs, adv_action_log_probs, rewards, masks, active_masks=None, adv_active_masks=None, available_actions=None):
    ...
    def recurrent_generator_actor_belief(self, advantages, actor_num_mini_batch, data_chunk_length):
        ...
        for indices in sampler:
            ...
            if self.factor is not None:
                yield obs_batch, obs_next_batch, belief_batch, ground_truth_type_batch, rnn_states_batch, adv_rnn_states_batch, belief_rnn_states_batch, actions_batch, adv_actions_batch,\
