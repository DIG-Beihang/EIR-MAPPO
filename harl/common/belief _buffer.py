...
class BeliefBuffer:
    ...
    def insert(self, obs, belief, ground_truth_type, belief_rnn_states, masks, active_masks=None):
    ...
    def after_update(self):
        ...
        self.belief[0] = self.belief[-1].copy()
    ...
    def recurrent_generator_belief(self, actor_num_mini_batch, data_chunk_length):
        ...
        for indices in sampler:
            ...
            if self.factor is not None:
                yield obs_batch, obs_next_batch, belief_batch, ground_truth_type_batch, belief_rnn_states_batch, masks_batch, active_masks_batch, factor_batch
            else:
                yield obs_batch, obs_next_batch, belief_batch, ground_truth_type_batch, belief_rnn_states_batch, masks_batch, active_masks_batch
