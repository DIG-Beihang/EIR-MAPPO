...
class CriticBufferFPBelief:
    ...
    def recurrent_generator_critic_belief(self, critic_num_mini_batch, data_chunk_length):
        ...
        belief_rnn_states_critic = self.belief_rnn_states_critic[:-1].transpose(1, 2, 0, 3, 4).reshape(-1, *self.belief_rnn_states_critic.shape[3:])
