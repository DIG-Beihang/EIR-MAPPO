...
from eir_mappo.env.ma_envs.agents.point_agents.pursuer_agent import PointAgent
from eir_mappo.env.ma_envs.agents.point_agents.evader_agent import Evader
